...
namespace WebUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await UserController.Login(model.UserName, model.Password);
            ...
            switch (result)
            {
                ...
                case Repository.BLL.SignInStatus.LockedOut:
                    return View("Lockout");
                case Repository.BLL.SignInStatus.RequiresVerification:
                    return RedirectToAction("SendCode", new { ReturnUrl = returnUrl, RememberMe = model.RememberMe });
                case Repository.BLL.SignInStatus.Failure:
                default:
        ...
        public async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            var result = Microsoft.AspNet.Identity.Owin.SignInStatus.Success;// await SignInManager.TwoFactorSignInAsync(model.Provider, model.Code, isPersistent:  model.RememberMe, rememberBrowser: model.RememberBrowser);
            switch (result)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            var result = await UserController.Register(model.UserName, model.Password);
